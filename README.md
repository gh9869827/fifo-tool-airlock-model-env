...
The script is based on the official [Phi-4-mini-instruct](https://huggingface.co/microsoft/Phi-4-mini-instruct) fine-tuning example, adapted for execution inside the isolated container and extended to support [fifo_tool_datasets](https://github.com/gh9869827/fifo-tool-datasets) adapters.
